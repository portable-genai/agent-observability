...
TWO_STATE_READS_WITH_A_REASON: dict[str, str] = {
    "DEMO_OUT": (
        "scripts/observability_demo.py: which file the offline demo writes its JSON transcript "
        "to. Presenter ergonomics on a synthetic run; it reaches no service, names no host and "
        "grants nothing."
    ),
}
