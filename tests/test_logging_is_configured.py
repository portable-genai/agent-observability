...
_PROFILE_ENV = "OBSERVABILITY_PROFILE"
_SERVED_MODULE = "observability.api.app"
_SERVICE = "agent-observability"
...
def _probe(profile: str) -> dict[str, Any]:
    ...
    out = subprocess.run(  # noqa: S603 - sys.executable and a literal probe, no input
...
def test_the_installed_cli_entry_point_configures_logging_too(
    ...
    cli_main = importlib.import_module("observability.cli.main")
